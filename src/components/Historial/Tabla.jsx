            ...
            <table className="w-[97%]">
                <thead>
                    <tr className="text-left">
                        ...
                        <th className="py-2 pr-2 pl-5"> <h4 className="blanco">Comments</h4> </th>
                    </tr>
                </thead>
                ...
                <tbody>
                    {filteredData.map((item, index) => (
                        <tr key={item.id} className={index % 2 === 0 ? "bg-[#333]" : ""}>
                            <td className={index % 2 === 0 ? "py-2 pr-2 pl-5 textos blanco rounded-l-[20px]" : "py-6 pr-2 pl-5 textos blanco rounded-l-[20px]"}>
